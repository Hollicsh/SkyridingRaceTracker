...
L["race-tracker-gliding-speed.name"] = "Скорость гонки"
L["race-tracker-gliding-speed.tooltip"] = "Определяет, должна ли отображаться скорость гонки во время полёта. Это работает только для гонок на драконах и скайрайдерах."
