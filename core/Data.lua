...
raceDataTable[219544] = {
    110102, 2248, {
        NORMAL   = {80220, 2924, 000000, 63, 68},
        ADVANCED = {80226, 2930, 000000, 60, 63},
        REVERSE  = {80232, 2936, 000000, 62, 65}
    }
}
-- Basin Bypass R3 (Beckenbypass) - R-11.0.5
raceDataTable[219547] = {
    110103, 2248, {
        NORMAL   = {80221, 2925, 000000, 58, 63},
        ADVANCED = {80227, 2931, 000000, 54, 57},
        REVERSE  = {80233, 2937, 000000, 57, 60}
    }
}
-- The Wold Ways R4 (Die Holtzwege) - R-11.0.5
raceDataTable[219548] = {
    110104, 2248, {
        NORMAL   = {80222, 2926, 000000, 68, 73},
        ADVANCED = {80228, 2932, 000000, 68, 71},
        REVERSE  = {80234, 2938, 000000, 70, 73}
    }
}
-- Thunderhead Trail R5 (Donnerkopfdreh) - R-11.0.5
raceDataTable[219549] = {
    110105, 2248, {
        NORMAL   = {80223, 2927, 000000, 70, 75},
        ADVANCED = {80229, 2933, 000000, 66, 69},
        REVERSE  = {80235, 2939, 000000, 66, 69}
    }
}
-- Orecreg's Doglegs R6 (Erzgrubenecken) - R-11.0.5
raceDataTable[219550] = {
    110106, 2248, {
        NORMAL   = {80224, 2928, 000000, 65, 70},
        ADVANCED = {80230, 2934, 000000, 61, 64},
        REVERSE  = {80236, 2940, 000000, 61, 64}
    }
}
...
raceDataTable[219551] = {
    110201, 2214, {
        NORMAL 	 = {80237, 2941, 000000, 52, 57},
        ADVANCED = {80244, 2947, 000000, 49, 52},
        REVERSE  = {80250, 2953, 000000, 50, 53}
    }
}
-- Ringing Deeps Ramble R2 (Schallende-Tiefen-Spektakel) - R-11.0.5
raceDataTable[219552] = {
    110202, 2214, {
        NORMAL 	 = {80238, 2942, 000000, 57, 62},
        ADVANCED = {80245, 2948, 000000, 53, 56},
        REVERSE  = {80251, 2954, 000000, 53, 56}
    }
}
-- Chittering Concourse R3 (Zirpendes Zusammentreffen) - R-11.0.5
raceDataTable[219553] = {
    110203, 2214, {
        NORMAL 	 = {80239, 2943, 000000, 56, 61},
        ADVANCED = {80246, 2949, 000000, 53, 56},
        REVERSE  = {80252, 2955, 000000, 54, 57}
    }
}
-- Cataract River Cruise R4 (Kataraktflussfahrt) - R-11.0.5
raceDataTable[219554] = {
    110204, 2214, {
        NORMAL 	 = {80240, 2944, 000000, 60, 65},
        ADVANCED = {80247, 2950, 000000, 58, 61},
        REVERSE  = {80253, 2956, 000000, 57, 60}
    }
}
-- Taelloch Twist R5 (Taellochtrick) - R-11.0.5
raceDataTable[219555] = {
    110205, 2214, {
        NORMAL 	 = {80242, 2945, 000000, 47, 52},
        ADVANCED = {80248, 2951, 000000, 43, 46},
        REVERSE  = {80254, 2957, 000000, 44, 47}
    }
}
-- Opportunity Point Amble R6 (Chancenspitzenchance) - R-11.0.5
raceDataTable[219556] = {
    110206, 2214, {
        NORMAL 	 = {80243, 2946, 000000, 77, 82},
        ADVANCED = {80249, 2952, 000000, 71, 74},
        REVERSE  = {80255, 2958, 000000, 72, 75}
    }
}
...
raceDataTable[219557] = {
    110301, 2215, {
        NORMAL    = {80256, 2959, 000000, 65, 70},
        ADVANCED  = {80265, 2965, 000000, 62, 65},
        REVERSE   = {80271, 2971, 000000, 64, 67}
    }
}
-- Tenir's Traversal R2 (Tenirs Traversale) - R-11.0.5
raceDataTable[219558] = {
    110302, 2215, {
        NORMAL    = {80257, 2960, 000000, 65, 70},
        ADVANCED  = {80266, 2966, 000000, 60, 63},
        REVERSE   = {80272, 2972, 000000, 63, 66}
    }
}
-- Light's Redoubt Descent R3 (Lichtschanzensturz) - R-11.0.5
raceDataTable[219559] = {
    110303, 2215, {
        NORMAL    = {80258, 2961, 000000, 63, 68},
        ADVANCED  = {80267, 2967, 000000, 62, 65},
        REVERSE   = {80273, 2973, 000000, 62, 65}
    }
}
-- Stillstone Slalom R4 (Stillsteinslalom) - R-11.0.5
raceDataTable[219560] = {
    110304, 2215, {
        NORMAL    = {80259, 2962, 000000, 56, 61},
        ADVANCED  = {80268, 2968, 000000, 54, 57},
        REVERSE   = {80274, 2974, 000000, 56, 59}
    }
}
-- Mereldar Meander R5 (Mereldarmäander) - R-11.0.5
raceDataTable[219561] = {
    110305, 2215, {
        NORMAL    = {80260, 2963, 000000, 76, 81},
        ADVANCED  = {80269, 2969, 000000, 71, 74},
        REVERSE   = {80275, 2975, 000000, 71, 74}
    }
}
-- Velhan's Venture R6 (Velhans Vorstoß) - R-11.0.5
raceDataTable[219562] = {
    110306, 2215, {
        NORMAL    = {80261, 2964, 000000, 55, 60},
        ADVANCED  = {80270, 2970, 000000, 50, 53},
        REVERSE   = {80276, 2976, 000000, 50, 53}
    }
}
...
raceDataTable[219564] = {
    110501, 2255, {
        NORMAL    = {80277, 2977, 000000, 78, 83},
        ADVANCED  = {80283, 2983, 000000, 74, 77},
        REVERSE   = {80289, 2989, 000000, 74, 77}
    }
}
-- Maddening Deep Dip R2 (Tiefenrausch des Wahnsinns) - R-11.0.5
raceDataTable[219565] = {
    110502, 2255, {
        NORMAL    = {80278, 2978, 000000, 58, 63},
        ADVANCED  = {80284, 2984, 000000, 54, 57},
        REVERSE   = {80290, 2990, 000000, 56, 59}
    }
}
-- The Weaver's Wing R3 (Der Wind der Weberin) - R-11.0.5
raceDataTable[219567] = {
    110503, 2255, {
        NORMAL    = {80279, 2979, 000000, 54, 59},
        ADVANCED  = {80285, 2985, 000000, 51, 54},
        REVERSE   = {80291, 2991, 000000, 50, 53}
    }
}
-- Rak-Ahat Rush R4 (Rak-Ahat-Rausch) - R-11.0.5
raceDataTable[219568] = {
    110504, 2255, {
        NORMAL    = {80280, 2980, 000000, 70, 75},
        ADVANCED  = {80286, 2986, 000000, 66, 69},
        REVERSE   = {80292, 2992, 000000, 66, 69}
    }
}
-- Pit Plunge R5 (Grubengerangel) - R-11.0.5
raceDataTable[219569] = {
    110505, 2255, {
        NORMAL    = {80281, 2981, 000000, 63, 68},
        ADVANCED  = {80287, 2987, 000000, 61, 64},
        REVERSE   = {80293, 2993, 000000, 61, 64}
    }
}
-- Siegehold Scuttle R6 (Belagerungsfestenbestrebung) - R-11.0.5
raceDataTable[219570] = {
    110506, 2255, {
        NORMAL    = {80282, 2982, 000000, 70, 75},
        ADVANCED  = {80288, 2988, 000000, 66, 69},
        REVERSE   = {80294, 2994, 000000, 63, 66}
    }
}
